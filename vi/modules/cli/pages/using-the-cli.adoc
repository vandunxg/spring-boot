...
Spring Boot bao gồm script command-line completion cho shell BASH và zsh.
Nếu bạn không dùng một trong hai shell này (có thể bạn là người dùng Windows), bạn có thể dùng command `shell` để khởi chạy một shell tích hợp, như ví dụ sau:
